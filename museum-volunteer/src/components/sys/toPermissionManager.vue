...
<el-button class="btn" style="margin-bottom:12px;" type="primary" icon="el-icon-edit" @click="addDialog" >新增权限</el-button>
   ...
   <el-table 
    ...
    @selection-change="handleSelectionChange"
      ...
      <el-table-column prop="perName" label="名称" align="center">
        </el-table-column>
      ...
      <el-table-column label="类型" prop="type"  align="center"> 
             <template slot-scope="scope">
                  ...
                  <el-tag type="warning" v-if="scope.row.type == '1'">权限</el-tag>
              </template>          
       </el-table-column>
      ...
      <el-table-column label="排序" prop="sort"  align="center">           
       ...
       <el-table-column label="权限码" prop="code"  align="center">           
       </el-table-column>
   ...
   <!--添加用户的对话框-->
<el-dialog title="新增权限" :visible.sync="addDialogVisible" width="30%" @close="addDialogClosed('addForm')">
      <!--内容主体区域-->
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="addPermission('addForm')">确 定</el-button>
      </span>
</el-dialog>
...
export default {
  ...
  methods: {
    ...
    getPermissionList(page,limit){
        this.axios.get("/sys/permission?page="+ page +"&limit="+ limit )
        .then(res=>{
    ...
    handleCurrentChange(cpage) {
        this.page = cpage;
        // console.log(cpage);//1
        this.getPermissionList(this.page,this.limit)
